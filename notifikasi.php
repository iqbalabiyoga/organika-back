<?php
  ...
  artikel_komentar_view WHERE artikel_view.id_user_input='$id_user' AND artikel_komentar_view.id_artikel=artikel_view.id_artikel ORDER BY artikel_komentar_view.tanggal_komentar DESC LIMIT $limit, 5;";
