<?php
  ...
  $sql = "SELECT id_artikel, id_kategori, id_topik, id_komoditas, judul_artikel, isi_artikel, artikel_status, tanggal, nama_user_input, total_baca, total_komentar FROM artikel_view WHERE id_kategori=2 AND is_remove='N' ORDER BY id_artikel DESC LIMIT $limit,5";
